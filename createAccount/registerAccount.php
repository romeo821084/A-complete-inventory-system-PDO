...
<?php if(isset($_SESSION['invalid'])):?>
    <h5 class="alert alert-danger"><?= $_SESSION['invalid']?>
...
<div class="container formStart">
    <form action="action.php" method="post">
        ...
        <div class="image">
            <img src="../image/newRoseLogo PNG.png" alt="Rose Tech Multimedia Logo">
        </div>
        ...
        <div class="form-group">
            <i class="fa fa-key"></i>
            <input type="password" name="cpassword" placeholder="Confirm Password" required id="myInput1" minlength="6">
        ...
        <div class="register">
            <input type="submit" name="registerBtn" class="registerBtn" value="Login">
            <p class="text-center mt-2">Already have an account? <a href="../index.php" class="ms-2">Login</a></p>
        </div>
</form>
</div>
<!-- LOGIN FORM END -->
